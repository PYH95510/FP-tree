        ...
        for (var kvPair: m_transactions.entrySet()) {
            ...
            Collections.sort(itemSet, new Comparator<Integer>() {
                ...
                public int compare(Integer arg0, Integer arg1) {
                    // If the attribute ID isn't in the list, then use -1 as the count. This shouldn't happen 
                    ...
                    // Note that the return value doesn't have to be {-1, 0, 1}. Returning any negative value 
